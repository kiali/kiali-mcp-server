...
func appTracesHandler(params api.ToolHandlerParams) (*api.ToolCallResult, error) {
	...
	content, err := kialiClient.AppTraces(params.Context, authHeader, namespace, app, queryParams)
	if err != nil {
...
func serviceTracesHandler(params api.ToolHandlerParams) (*api.ToolCallResult, error) {
	...
	content, err := kialiClient.ServiceTraces(params.Context, authHeader, namespace, service, queryParams)
	if err != nil {
...
func workloadTracesHandler(params api.ToolHandlerParams) (*api.ToolCallResult, error) {
	...
	content, err := kialiClient.WorkloadTraces(params.Context, authHeader, namespace, workload, queryParams)
	if err != nil {
